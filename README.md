...
```
cd existing_repo
git remote add origin https://github.com/narayangit/laravel9_hris.git
git branch -M main
...
- [ ] [Set up project integrations](https://github.com/narayangit/laravel9_hris/-/settings/integrations)
